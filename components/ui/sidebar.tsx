...
const navigation = [
  ...
  { name: 'Ask AI', href: '/ask', icon: BrainCircuit },
  { name: 'Earth', href: '/earth', icon: Globe },
  { name: 'Saturn', href: '/saturn', icon: Saturn },
  { name: 'Neptune', href: '/neptune', icon: Cloud },
  { name: 'Moon', href: '/moon', icon: Moon },
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-64 bg-white dark:bg-gray-900 p-0"
            side={side}
          >
